...
# TEST 8: test5 + 야간 제약 (overlap 제약 스킵)
...
print(f'=== TEST 8: {len(actual)} constraints (skip overlap + max_wait) ===')
print(f'  Added: day_duty_start, day_duty_end, night_duty_start, day_night_classification, night_sleep_guarantee')
