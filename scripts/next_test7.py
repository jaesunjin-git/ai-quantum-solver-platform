...
# TEST 7: test5 + min_wait_time, max_single_wait_time (max_wait_time 스킵)
test_names = ['trip_coverage', 'max_driving_time', 'max_work_time', 'preparation_time', 'cleanup_time',
              ...
              'min_wait_time', 'max_single_wait_time']
...
print(f'=== TEST 7: {len(actual)} constraints (skip max_wait_time) ===')
print(f'  Added: min_wait_time, max_single_wait_time')
