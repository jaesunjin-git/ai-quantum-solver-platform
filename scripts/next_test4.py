...
# TEST 4: test3 + mandatory_break, meal_break_guarantee
test_names = ['trip_coverage', 'max_driving_time', 'max_work_time', 'preparation_time', 'cleanup_time',
              'mandatory_break', 'meal_break_guarantee']
...
print(f'=== TEST 4: {len(actual)} constraints ===')
print(f'  Added: mandatory_break, meal_break_guarantee')
