...
import { Activity, Download, FileText, Play } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-[11px] text-slate-400">
                ...
                <span>{model.problem_name || '수학 모델'}</span>
                <span>·</span>
        ...
        {constraints.length > 0 && (
          ...
          <h3 className="text-sm font-semibold text-white">🗣️ 제약 조건</h3>
            <div className="space-y-2">
              {constraints.slice(0, 8).map((c: any, idx: number) => (
              ...
              {constraints.length > 8 && (
                <p className="text-[12px] text-slate-500">... 외 {constraints.length - 8}개</p>
              )}
            </div>
          </div>
        )}
